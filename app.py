...
# Visualization: Credit Utilization Ratio Distribution
...
# Calculate credit scores using a custom formula
credit_scores = []
...
for index, row in data.iterrows():
    ...
    # Apply the formula to calculate the credit score
...
# Visualize the segments with meaningful names
fig = px.scatter(data, x=data.index, y='Credit Score', color='Segment',
                 color_discrete_sequence=['green', 'blue', 'yellow', 'red'])
fig.update_layout(
    xaxis_title='Customer Index',
